...
const App = () => {
  ...
  // Initialize chat log with system and assistant messages
  useEffect(() => {
...
\`\`\`
  ...
  // Auto-scroll when chatLog or isLoading changes
  useEffect(() => {
  ...
  const handleGenerateText = useCallback(async () => {
    ...
    // Prepare conversation context by mapping chatLog to the OpenAI API format
    // We combine the previous chatLog with the new userMessage (excluding the typing message)
